...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{graphics/bang7.jpg}
...
\end{figure}
\textbf{Nhận xét:} lần lượt cho  nearest\_warehouse, season, is\_expedited\_delivery, is\_happy\_customer.\\
